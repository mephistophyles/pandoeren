...
describe('Hot-seat app', () => {
  ...
  it('shows selected trump and called card while computing open roem automatically', () => {
    render(<App />);
    ...
    expect(screen.queryByLabelText(/open roem/i)).not.toBeInTheDocument();
    ...
    expect(screen.getByText(/open roem: /i)).toBeInTheDocument();
    expect(screen.getByText(/bid adjustment: /i)).toBeInTheDocument();
  });
